...
const ENDPOINT = process.env.REACT_API_URL || "http://localhost:5000"; // replace the url with "https://YOUR_DEPLOYED_APPLICATION_URL" then run "npm run build" to create a production build in a production mode
